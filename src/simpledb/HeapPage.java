...
public class HeapPage implements Page {
	...
	public Iterator<Tuple> iterator() {
		...
		return new HeapPageIterator<Tuple>(tup);
	...
	public Tuple getTuple(int entryID) {
		...
		DataInputStream in=new DataInputStream(new ByteArrayInputStream(data,tupleLocation(entryID),data.length-tupleLocation(entryID)));
	...
	protected void saveTupleLocation(int entryID, int location) {
		// some code goes here
		// not necessary for assignment1
		writeInt(data,tupleLocation(entryID),location);
